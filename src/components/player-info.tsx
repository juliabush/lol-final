...
export function PlayerInfo({ puuid, gameName, tagLine }: PlayerInfoProps) {
  ...
  return (
    <div className="bg-gray-100 rounded-lg">
      <div className="gap-4 flex items-center sm:gap-6 dark:bg-neutral-900 dark:text-white">
        ...
        <div>
          <div className="flex items-star gap-1">
            ...
            <span className="px-2 h-8 sm:ml-2 py-2 sm:py-2.5 sm:h-10 sm:px-3 text-sm bg-blue-100 text-blue-800 rounded-full">
              {regionDisplay}
            </span>
          </div>
